...
import com.example.trasua1.ui.dangxuat.DangXuatFragment;
    ...
    private void updateUserProfile() {
        ...
        reference.child(userID).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onSuccess(Object o) {
                ...
                NavHostFragment.findNavController(HoSoFragment.this).navigate(R.id.action_nav_hoso_to_nav_trangchu);
            }
        });
    }
