                ...
                for (DocumentSnapshot documentSnapshot:task.getResult().getDocuments()){
                    ...
                    viewAllAdapter.setOnItemCLick(new OnItemClick() {
                        ...
                        public void onUpdate(int position) {
                            ...
                            final Dialog dialog = new Dialog(ViewAllActivity1.this);
                            ...
                            firestore.collection("AllSanPham").document(item_id).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                ...
                                public void onFailure(@NonNull @org.jetbrains.annotations.NotNull Exception e) {
                                    Toast.makeText(ViewAllActivity1.this, "Có Lỗi Xảy ra"+e.getMessage(), Toast.LENGTH_SHORT).show();
                            ...
                            btnEdit.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (saveUri != null){
                                        ProgressDialog mDialog = new ProgressDialog(ViewAllActivity1.this);
                                        ...
                                        reference.putFile(saveUri)
                                                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                    ...
                                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                        ...
                                                        Toast.makeText(ViewAllActivity1.this,"Uploaded",Toast.LENGTH_LONG).show();
                                                            ...
                                                            public void onSuccess(Uri uri) {
                                                                ...
                                                                firestore.collection("AllSanPham").document(item_id).update(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                    ...
                                                                    public void onSuccess(Void unused) {
                                                                        Toast.makeText(ViewAllActivity1.this, "Cập nhật thành công", Toast.LENGTH_SHORT).show();
                                                                        viewAllAdapter.notifyItemChanged(position);
                                                                    }
                                                                }).addOnFailureListener(new OnFailureListener() {
                                                                    @Override
                                                                    public void onFailure(@NonNull @org.jetbrains.annotations.NotNull Exception e) {
                                                                        Toast.makeText(ViewAllActivity1.this, "Cập nhật thất bại"+e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                    }
                                                                });
                                                                dialog.dismiss();
                                            ...
                                            public void onFailure(@NonNull @org.jetbrains.annotations.NotNull Exception e) {
                                                mDialog.dismiss();
                                                Toast.makeText(ViewAllActivity1.this,""+e.getMessage(),Toast.LENGTH_LONG).show();
                                            }
                        ...
                        public void onDelete(int position) {
                            ...
                            btnDelete.setOnClickListener(new View.OnClickListener() {
                                ...
                                firestore.collection("AllSanPham").document(item_id).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(ViewAllActivity1.this, "Xóa thành công", Toast.LENGTH_SHORT).show();
                                        viewAllAdapter.notifyItemRemoved(position);
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull @org.jetbrains.annotations.NotNull Exception e) {
                                        Toast.makeText(ViewAllActivity1.this, "Xóa thất bại"+e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                                    dialog.dismiss();
                                }
